...
import { Loader2, DollarSign, QrCode, Download, Copy, Wallet } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const PaymentFormContent = ({ onSuccess, embedded = false }: PaymentFormProps) => {
...
I am attaching my payment proof in this chat.`;
  ...
  return (
    <form onSubmit={handleWhatsAppRedirect} className={embedded ? "space-y-6" : "p-6 space-y-6"}>
      {/* 1. Datos del Usuario */}
                ...
                <div className="space-y-4 py-4 w-full animate-in fade-in duration-300">
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center gap-2 mt-1">
                          ...
                          <Button variant="ghost" size="icon" className="h-6 w-6" type="button" onClick={() => handleCopy(PAYPAL_EMAIL, "Email PayPal")}>
                ...
                <div className="space-y-4 py-4 w-full animate-in fade-in duration-300">
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center gap-2 mt-1">
                            ...
                            <Button variant="ghost" size="icon" className="h-6 w-6" type="button" onClick={() => handleCopy(BINANCE_PAY_ID, "Binance ID")}>
                                <Copy className="h-3 w-3" />
                            </Button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center gap-2 mt-1">
                            ...
                            <Button variant="ghost" size="icon" className="h-6 w-6" type="button" onClick={() => handleCopy(BINANCE_USDT_ADDRESS, "Dirección USDT")}>
                                <Copy className="h-3 w-3" />
                            </Button>
                        </div>
                    </div>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#0a0a0a] border border-border/50 max-w-lg p-0 max-h-[90vh] overflow-y-auto">
        ...
        <PaymentFormContent onSuccess={() => setTimeout(onClose, 5000)} />
      </DialogContent>
    </Dialog>
  );
};
